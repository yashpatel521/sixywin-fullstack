  ...
  return (
    <section className="relative py-12 sm:py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl space-y-8">
        ...
        <h1 className="text-5xl sm:text-7xl font-black tracking-tight text-[#fbf8f3] leading-[1.08]">
        ...
        <p className="text-[#e8dfd1] text-base sm:text-xl max-w-2xl font-normal leading-relaxed">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2">
          <button
            onClick={onPlayClick}
            className="px-9 py-4 text-sm font-extrabold text-[#1a100a] bg-gradient-to-r from-[#d4af37] via-[#e5c158] to-[#b8860b] hover:from-[#e5c158] hover:to-[#d4af37] rounded-2xl transition-all shadow-xl shadow-[#d4af37]/20 active:scale-95 flex items-center gap-2 cursor-pointer border border-[#fffdfa]/30"
          >
          ...
          <button
            ...
            className="px-8 py-4 text-sm font-bold text-[#fbf8f3] hover:text-white bg-[#2c1d11]/80 hover:bg-[#3a2717] border border-[#8c5a2b]/50 rounded-2xl transition-all flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-10 border-t border-[#8c5a2b]/30 text-xs">
          <div>
            <span className="text-[#a89582] font-semibold block mb-1">TOTAL PAYOUTS</span>
            <span className="text-lg font-bold text-[#fbf8f3] font-mono">$24,850,000+</span>
          </div>
          <div>
            <span className="text-[#a89582] font-semibold block mb-1">AVERAGE RTP</span>
            <span className="text-lg font-bold text-[#d4af37] font-mono">99.1%</span>
          </div>
          <div>
            <span className="text-[#a89582] font-semibold block mb-1">VIP CASHBACK</span>
            <span className="text-lg font-bold text-[#e5c158] font-mono">15% WEEKLY</span>
          </div>
          <div>
            <span className="text-[#a89582] font-semibold block mb-1">SETTLEMENT</span>
            <span className="text-lg font-bold text-[#fbf8f3] font-mono">&lt; 1 SEC</span>
          </div>
        </div>
      </div>
    </section>
