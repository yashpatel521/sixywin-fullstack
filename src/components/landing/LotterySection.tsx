    ...
    <section className="relative w-full bg-gradient-to-b from-[#18120e] via-[#281c14] to-[#faf6f0] px-6 sm:px-16 py-24 text-[#faf6f0] m-0 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-[#9c663b]/30 pb-8">
          ...
          {/* Live Jackpot Banner */}
          <div className="rounded-3xl bg-[#18120e] border border-[#e6ca65]/50 p-6 space-y-2 shadow-2xl shrink-0">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#18120e] hover:bg-[#281d14] border border-[#9c663b]/60 text-[#e6ca65] text-xs font-extrabold flex items-center gap-1.5 transition-all cursor-pointer"
              >
            ...
            <div className="rounded-3xl bg-gradient-to-br from-[#281d14] via-[#18120e] to-[#0c0a09] border border-[#e6ca65]/60 p-8 space-y-6 shadow-2xl">
              ...
              <div className="flex items-center justify-between gap-2 py-2">
                {selectedNumbers.map((num, idx) => (
                  <div
                    key={idx}
                    className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-gradient-to-tr from-[#e6ca65] via-[#d4af37] to-[#b5952f] text-[#0c0a09] font-black font-mono text-base sm:text-lg flex items-center justify-center shadow-lg shadow-[#d4af37]/25"
                  >
                    {num < 10 ? `0${num}` : num}
                  </div>
                ))}
