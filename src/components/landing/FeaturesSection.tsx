...
export const FeaturesSection: React.FC = () => {
  return (
    <section className="relative w-full bg-gradient-to-b from-[#faf6f0] via-[#f3ebd9] to-[#18120e] px-6 sm:px-16 py-20 text-[#18120e] m-0 overflow-hidden">
      <div className="relative z-10 w-full max-w-[1800px] mx-auto space-y-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 border-b border-[#9c663b]/25 pb-6">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#18120e] text-[#e6ca65] text-xs font-bold border border-[#9c663b]/40 shadow-sm">
              <Crown className="w-3.5 h-3.5 text-[#e6ca65]" />
              <span>ELITE ADVANTAGES</span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-[#18120e]">
              Why High Rollers Choose SixyWin
            </h2>
          </div>
          <p className="text-sm sm:text-base font-medium text-[#6e5847] max-w-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="rounded-3xl bg-[#18120e] border border-[#9c663b]/40 p-8 space-y-4 text-[#faf6f0] shadow-2xl hover:-translate-y-1.5 transition-all">
            ...
            <h3 className="text-xl sm:text-2xl font-extrabold text-[#faf6f0]">15% Weekly SC Bonus</h3>
            <p className="text-[#b5a391] text-xs sm:text-sm leading-relaxed">
          ...
          <div className="rounded-3xl bg-[#18120e] border border-[#9c663b]/40 p-8 space-y-4 text-[#faf6f0] shadow-2xl hover:-translate-y-1.5 transition-all">
            ...
            <h3 className="text-xl sm:text-2xl font-extrabold text-[#faf6f0]">Instant Settlement</h3>
            <p className="text-[#b5a391] text-xs sm:text-sm leading-relaxed">
          ...
          <div className="rounded-3xl bg-[#18120e] border border-[#9c663b]/40 p-8 space-y-4 text-[#faf6f0] shadow-2xl hover:-translate-y-1.5 transition-all">
            ...
            <h3 className="text-xl sm:text-2xl font-extrabold text-[#faf6f0]">Provably Fair Engine</h3>
            <p className="text-[#b5a391] text-xs sm:text-sm leading-relaxed">
