...
import { ShieldCheck, Crown, HeartHandshake, Sparkles, Coins } from 'lucide-react';

export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#0c0a09] border-t border-[#9c663b]/30 px-6 sm:px-16 pt-16 pb-12 text-[#faf6f0] m-0">
      <div className="w-full max-w-7xl mx-auto space-y-12">
        {/* Top Grid: Logo & Column Links */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#18120e] border border-[#9c663b]/50 text-[#e6ca65] text-xs font-mono font-bold">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#9c663b]/30 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#b5a391]">
