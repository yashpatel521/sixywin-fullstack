...
import { Mail, Lock, Eye, EyeOff, LogIn, Crown, ArrowRight, ShieldCheck, Trophy, Sparkles } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-4rem)] max-h-[calc(100vh-4rem)] bg-gradient-to-b from-[#0c0a09] via-[#18120e] to-[#0c0a09] px-6 sm:px-16 flex items-center justify-center py-6 m-0 overflow-hidden">
      {/* 24K Champagne Gold Ambient Glows */}
      <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#d4af37]/12 rounded-full blur-[180px] pointer-events-none" />
